...
//
// import { CdkStickyHeaderModule, CdkStickyRegion, CdkStickyHeader } from './index';
...
//             imports: [CdkStickyHeaderModule, OverlayModule, MdCommonModule, CommonModule],
//             declarations: [
//                 TestApp
//             ],
//         });
...
//
//     it('md-sticky-viewport element should have sticky-parent class in its classList', () => {
//         fixture.detectChanges();
//         expect(stickyParentElement.nativeElement.classList.contains('sticky-parent')).toBe(true);
//     });
//
//     it('make sure has the sticky-parent element afterViewInit()',
//         fakeAsync(() => {
//             fixture.detectChanges();
...
//             tick(0);
//             fixture.detectChanges();
//             expect(stickyHeaderDir.element.style.bottom).toEqual('0px');
//         }));
//
...
//             tick(0);
//             fixture.detectChanges();
//             expect(stickyHeaderDir.element.style.width).toEqual(exp);
//         }));
//
//
// });
