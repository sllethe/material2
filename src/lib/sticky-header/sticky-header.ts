...
import {Directive, Input,
  OnDestroy, AfterViewInit, ElementRef, Optional, InjectionToken, Injectable, Inject} from '@angular/core';
...
export class CdkStickyHeader implements OnDestroy, AfterViewInit {
  ...
  constructor(element: ElementRef,
              ...
              platform: Platform, @Inject(STICKY_HEADER_SUPPORT_STRATEGY) public _spCheck) {
  ...
  private _setStrategyAccordingToCompatibility(): void {
    ...
    this._isPositionStickySupported = this._spCheck;
